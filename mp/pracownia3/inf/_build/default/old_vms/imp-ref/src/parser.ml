...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LEQ
    | INT of (
# 1 "old_vms/imp-ref/src/parser.mly"
       (int)
# 32 "old_vms/imp-ref/src/parser.ml"
  )
    | IF
    | IDENT of (
# 2 "old_vms/imp-ref/src/parser.mly"
       (string)
# 38 "old_vms/imp-ref/src/parser.ml"
  )
    | GT
    | GEQ
    | FALSE
...
# 12 "old_vms/imp-ref/src/parser.mly"
  
open Ast

# 61 "old_vms/imp-ref/src/parser.ml"
...
# 2 "old_vms/imp-ref/src/parser.mly"
       (string)
# 200 "old_vms/imp-ref/src/parser.ml"
)
...
let _menhir_action_01 =
  fun n ->
    (
# 25 "old_vms/imp-ref/src/parser.mly"
            ( Int n )
# 226 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_02 =
  fun x ->
    (
# 26 "old_vms/imp-ref/src/parser.mly"
            ( Var x )
# 234 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_03 =
  fun e ->
    (
# 27 "old_vms/imp-ref/src/parser.mly"
                           ( e )
# 242 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_04 =
  fun e1 e2 ->
    (
# 28 "old_vms/imp-ref/src/parser.mly"
                            ( Binop(Add, e1, e2) )
# 250 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_05 =
  fun e1 e2 ->
    (
# 29 "old_vms/imp-ref/src/parser.mly"
                            ( Binop(Sub, e1, e2) )
# 258 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_06 =
  fun e1 e2 ->
    (
# 30 "old_vms/imp-ref/src/parser.mly"
                            ( Binop(Mul, e1, e2) )
# 266 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_07 =
  fun e1 e2 ->
    (
# 31 "old_vms/imp-ref/src/parser.mly"
                            ( Binop(Div, e1, e2) )
# 274 "old_vms/imp-ref/src/parser.ml"
     : (Ast.aexp))

let _menhir_action_08 =
  fun () ->
    (
# 44 "old_vms/imp-ref/src/parser.mly"
          ( Bool true  )
# 282 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_09 =
  fun () ->
    (
# 45 "old_vms/imp-ref/src/parser.mly"
          ( Bool false )
# 290 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_10 =
  fun e ->
    (
# 46 "old_vms/imp-ref/src/parser.mly"
                           ( e )
# 298 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_11 =
  fun e1 e2 op ->
    (
# 47 "old_vms/imp-ref/src/parser.mly"
                               ( Cmp(op, e1, e2) )
# 306 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_12 =
  fun e1 e2 ->
    (
# 48 "old_vms/imp-ref/src/parser.mly"
                          ( And(e1, e2) )
# 314 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_13 =
  fun e1 e2 ->
    (
# 49 "old_vms/imp-ref/src/parser.mly"
                          ( Or(e1, e2)  )
# 322 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_14 =
  fun e ->
    (
# 50 "old_vms/imp-ref/src/parser.mly"
                ( Not e )
# 330 "old_vms/imp-ref/src/parser.ml"
     : (Ast.bexp))

let _menhir_action_15 =
  fun () ->
    (
# 35 "old_vms/imp-ref/src/parser.mly"
        ( Eq  )
# 338 "old_vms/imp-ref/src/parser.ml"
     : (Ast.cmpop))

let _menhir_action_16 =
  fun () ->
    (
# 36 "old_vms/imp-ref/src/parser.mly"
        ( Neq )
# 346 "old_vms/imp-ref/src/parser.ml"
     : (Ast.cmpop))

let _menhir_action_17 =
  fun () ->
    (
# 37 "old_vms/imp-ref/src/parser.mly"
        ( Lt  )
# 354 "old_vms/imp-ref/src/parser.ml"
     : (Ast.cmpop))

let _menhir_action_18 =
  fun () ->
    (
# 38 "old_vms/imp-ref/src/parser.mly"
        ( Gt  )
# 362 "old_vms/imp-ref/src/parser.ml"
     : (Ast.cmpop))

let _menhir_action_19 =
  fun () ->
    (
# 39 "old_vms/imp-ref/src/parser.mly"
        ( Leq )
# 370 "old_vms/imp-ref/src/parser.ml"
     : (Ast.cmpop))

let _menhir_action_20 =
  fun () ->
    (
# 40 "old_vms/imp-ref/src/parser.mly"
        ( Geq )
# 378 "old_vms/imp-ref/src/parser.ml"
     : (Ast.cmpop))
...
# 216 "<standard.mly>"
    ( [] )
# 386 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt list))
...
# 219 "<standard.mly>"
    ( x :: xs )
# 394 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt list))
...
# 216 "<standard.mly>"
    ( [] )
# 402 "old_vms/imp-ref/src/parser.ml"
     : (string list))
...
# 219 "<standard.mly>"
    ( x :: xs )
# 410 "old_vms/imp-ref/src/parser.ml"
     : (string list))

let _menhir_action_25 =
  fun s vs ->
    (
# 68 "old_vms/imp-ref/src/parser.mly"
                                   ( (vs, s) )
# 418 "old_vms/imp-ref/src/parser.ml"
     : (Ast.prog))

let _menhir_action_26 =
  fun () ->
    (
# 54 "old_vms/imp-ref/src/parser.mly"
         ( Block [] )
# 426 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_27 =
  fun s ->
    (
# 55 "old_vms/imp-ref/src/parser.mly"
                           ( Block s )
# 434 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_28 =
  fun e x ->
    (
# 56 "old_vms/imp-ref/src/parser.mly"
                          ( Assgn(x, e) )
# 442 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_29 =
  fun c s1 s2 ->
    (
# 57 "old_vms/imp-ref/src/parser.mly"
                                             ( If(c, s1, s2) )
# 450 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_30 =
  fun c s ->
    (
# 58 "old_vms/imp-ref/src/parser.mly"
                              ( While(c, s) )
# 458 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_31 =
  fun x ->
    (
# 59 "old_vms/imp-ref/src/parser.mly"
                  ( Read x )
# 466 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_32 =
  fun e ->
    (
# 60 "old_vms/imp-ref/src/parser.mly"
                  ( Write e )
# 474 "old_vms/imp-ref/src/parser.ml"
     : (Ast.stmt))

let _menhir_action_33 =
  fun x ->
    (
# 64 "old_vms/imp-ref/src/parser.mly"
                 ( x )
# 482 "old_vms/imp-ref/src/parser.ml"
     : (string))
