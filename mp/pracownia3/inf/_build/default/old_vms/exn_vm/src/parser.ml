...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LEQ
    | INT of (
# 10 "old_vms/exn_vm/src/parser.mly"
       (int)
# 30 "old_vms/exn_vm/src/parser.ml"
  )
    | IN
    | IF
    | IDENT of (
# 11 "old_vms/exn_vm/src/parser.mly"
       (string)
# 37 "old_vms/exn_vm/src/parser.ml"
  )
    | GT
    | GEQ
    | FUN
...
# 1 "old_vms/exn_vm/src/parser.mly"
...
# 63 "old_vms/exn_vm/src/parser.ml"
...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState15 : ((('s, _menhir_box_prog) _menhir_cell1_FUN, _menhir_box_prog) _menhir_cell1_idents, _menhir_box_prog) _menhir_state
    (** State 15.
  ...
  | MenhirState52 : ((('s, _menhir_box_prog) _menhir_cell1_LET _menhir_cell0_IDENT, _menhir_box_prog) _menhir_cell1_mixfix, _menhir_box_prog) _menhir_state
    (** State 52.
        Stack shape : LET IDENT mixfix.
        Start symbol: prog. *)

  | MenhirState57 : ((('s, _menhir_box_prog) _menhir_cell1_TRY, _menhir_box_prog) _menhir_cell1_mixfix, _menhir_box_prog) _menhir_state
    (** State 57.
...
# 11 "old_vms/exn_vm/src/parser.mly"
       (string)
# 211 "old_vms/exn_vm/src/parser.ml"
)
...
# 11 "old_vms/exn_vm/src/parser.mly"
       (string)
# 218 "old_vms/exn_vm/src/parser.ml"
)
...
let _menhir_action_01 =
  fun e1 e2 ->
    (
# 63 "old_vms/exn_vm/src/parser.mly"
                        ( App(e1, e2) )
# 241 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_02 =
  fun () ->
    (
# 64 "old_vms/exn_vm/src/parser.mly"
          ( Raise )
# 249 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_03 =
  fun e ->
    (
# 65 "old_vms/exn_vm/src/parser.mly"
             ( e )
# 257 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_04 =
  fun i ->
    (
# 69 "old_vms/exn_vm/src/parser.mly"
            ( Int i )
# 265 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_05 =
  fun x ->
    (
# 70 "old_vms/exn_vm/src/parser.mly"
              ( Var x )
# 273 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_06 =
  fun e ->
    (
# 71 "old_vms/exn_vm/src/parser.mly"
                               ( e )
# 281 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_07 =
  fun () ->
    (
# 72 "old_vms/exn_vm/src/parser.mly"
         ( Bool true )
# 289 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_08 =
  fun () ->
    (
# 73 "old_vms/exn_vm/src/parser.mly"
          ( Bool false )
# 297 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_09 =
  fun e1 e2 ->
    (
# 47 "old_vms/exn_vm/src/parser.mly"
                               ( Binop(Add, e1, e2) )
# 305 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_10 =
  fun e1 e2 ->
    (
# 48 "old_vms/exn_vm/src/parser.mly"
                                ( Binop(Sub, e1, e2) )
# 313 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_11 =
  fun e1 e2 ->
    (
# 49 "old_vms/exn_vm/src/parser.mly"
                              ( Binop(Div, e1, e2) )
# 321 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_12 =
  fun e1 e2 ->
    (
# 50 "old_vms/exn_vm/src/parser.mly"
                                ( Binop(Mult, e1, e2) )
# 329 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_13 =
  fun e1 e2 ->
    (
# 51 "old_vms/exn_vm/src/parser.mly"
                             ( Binop(Eq, e1, e2) )
# 337 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_14 =
  fun e1 e2 ->
    (
# 52 "old_vms/exn_vm/src/parser.mly"
                             ( Binop(Lt, e1, e2) )
# 345 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_15 =
  fun e1 e2 ->
    (
# 53 "old_vms/exn_vm/src/parser.mly"
                             ( Binop(Gt, e1, e2) )
# 353 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_16 =
  fun e1 e2 ->
    (
# 54 "old_vms/exn_vm/src/parser.mly"
                              ( Binop(Leq, e1, e2) )
# 361 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_17 =
  fun e1 e2 ->
    (
# 55 "old_vms/exn_vm/src/parser.mly"
                              ( Binop(Geq, e1, e2) )
# 369 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_18 =
  fun e1 e2 ->
    (
# 56 "old_vms/exn_vm/src/parser.mly"
                              ( Binop(Neq, e1, e2) )
# 377 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_19 =
  fun e1 e2 ->
    (
# 57 "old_vms/exn_vm/src/parser.mly"
                              ( Binop(And, e1, e2) )
# 385 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_20 =
  fun e1 e2 ->
    (
# 58 "old_vms/exn_vm/src/parser.mly"
                             ( Binop(Or, e1, e2) )
# 393 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_21 =
  fun e ->
    (
# 59 "old_vms/exn_vm/src/parser.mly"
            ( e )
# 401 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_22 =
  fun x xs ->
    (
# 34 "old_vms/exn_vm/src/parser.mly"
                           ( x :: xs )
# 409 "old_vms/exn_vm/src/parser.ml"
     : (string list))

let _menhir_action_23 =
  fun x ->
    (
# 35 "old_vms/exn_vm/src/parser.mly"
              ( [x] )
# 417 "old_vms/exn_vm/src/parser.ml"
     : (string list))

let _menhir_action_24 =
  fun e1 e2 e3 ->
    (
# 39 "old_vms/exn_vm/src/parser.mly"
                                                          ( If(e1, e2, e3) )
# 425 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_25 =
  fun e1 e2 x ->
    (
# 40 "old_vms/exn_vm/src/parser.mly"
                                                     ( Let(x, e1, e2) )
# 433 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_26 =
  fun e xs ->
    (
# 41 "old_vms/exn_vm/src/parser.mly"
                                      ( make_funs xs e )
# 441 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_27 =
  fun e1 e2 ->
    (
# 42 "old_vms/exn_vm/src/parser.mly"
                                        ( Try(e1, e2) )
# 449 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_28 =
  fun e ->
    (
# 43 "old_vms/exn_vm/src/parser.mly"
             ( e )
# 457 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))

let _menhir_action_29 =
  fun e ->
    (
# 30 "old_vms/exn_vm/src/parser.mly"
                    ( e )
# 465 "old_vms/exn_vm/src/parser.ml"
     : (Ast.expr))
...
include struct
  ...
  and _menhir_goto_app : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | AND | DIV | ELSE | EOF | EQ | GEQ | GT | IN | LEQ | LT | MINUS | NEQ | OR | PLUS | RPAREN | THEN | TIMES | WITH ->
          let e = _v in
  ...
  and _menhir_run_43 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | DIV ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
          _menhir_run_26 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | ELSE | EOF | IN | OR | RPAREN | THEN | WITH ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1) = _menhir_stack in
          let e2 = _v in
  ...
  and _menhir_run_33 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | DIV ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
          _menhir_run_26 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | ELSE | EOF | EQ | GEQ | GT | IN | LEQ | LT | MINUS | NEQ | OR | PLUS | RPAREN | THEN | WITH ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1) = _menhir_stack in
          let e2 = _v in
  ...
  and _menhir_run_58 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_TRY, _menhir_box_prog) _menhir_cell1_mixfix -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
  ...
  and _menhir_run_56 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_TRY as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
  ...
  and _menhir_run_53 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_LET _menhir_cell0_IDENT, _menhir_box_prog) _menhir_cell1_mixfix -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      let MenhirCell1_mixfix (_menhir_stack, _, e1) = _menhir_stack in
  ...
  and _menhir_run_17 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_FUN, _menhir_box_prog) _menhir_cell1_idents -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
