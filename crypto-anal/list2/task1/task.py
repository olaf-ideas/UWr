...
key = binascii.unhexlify('7dfa554b1b7f08bb6cdfa868594d47bf')
iv = binascii.unhexlify('103f182962a783d5b847de76e20ef159')
...
for line in ciphertext_hex:
	...
	plaintext = decryptor.update(line) + decryptor.finalize()
